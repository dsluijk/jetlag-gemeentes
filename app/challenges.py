...
CHALLENGES: Dict[str, Challenge] = {
    ...
    'Almelo': Challenge(
        ...
        description='Film a traffic light changing to red, and then within 10 seconds a different traffic light changing to green. https://youtu.be/63f2xQTuQ3g',
    ),
    'Apeldoorn': Challenge(
    ...
    'Dalfsen': Challenge(
        title='',
        description='Get a perfect score on 30 seconds. Go to https://30secondenspel.nl/ and use the standard difficulty. Take turns explaining the words to your teammates. Keep going until you get 5/5 words on a turn. You are not allowed to skip turns.',
    ),
    'Deventer': Challenge(
        title='',
    ...
    'Zwolle': Challenge(
        title='',
        description='Welcome to Zwollywood! Go to a movie theater and play "Finish the famous movie line" from this BuzzFeed quiz:  https://www.buzzfeed.com/kaylayandoli/finish-famous-movie-quotes-quiz. You must do them in order and wait 30 seconds between guesses. If you fail completely, look up another quiz :)',
    ),
